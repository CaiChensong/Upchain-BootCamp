...
import "../../src/W4D3/NFTMarketBetterGas.sol";
import "../../src/W2D2/ERC20Hook.sol";
import "../../src/W2D2/ERC721.sol";

contract NFTMarketBetterGasTest is Test {
    NFTMarketBetterGas public nftMarket;
    ...
    function setUp() public {
        ...
        // 部署 NFT 市场合约
        nftMarket = new NFTMarketBetterGas(address(token), address(nft));
    ...
    function test_ListNFT() public {
        ...
        // 验证上架状态
        (uint128 price, address seller) = nftMarket.listings(TOKEN_ID_1);
    ...
    function test_ListMultipleNFTs() public {
        ...
        // 验证两个 NFT 的上架状态
        (uint128 price1, address seller1) = nftMarket.listings(TOKEN_ID_1);
        (uint128 price2, address seller2) = nftMarket.listings(TOKEN_ID_2);
        assertEq(price1, NFT_PRICE);
        assertEq(seller1, alice);
        assertEq(price2, NFT_PRICE * 2);
        assertEq(seller2, bob);
